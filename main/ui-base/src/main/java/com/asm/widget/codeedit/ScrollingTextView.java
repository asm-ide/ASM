 ...
 */
public class ScrollingTextView extends View implements TextViewInterface, TextsDrawingInterface, GestureDetector.OnGestureListener, CharSequence, TextData.OnInvaildateListener
{
