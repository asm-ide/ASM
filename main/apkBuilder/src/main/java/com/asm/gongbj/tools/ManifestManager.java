...
public class ManifestManager
{
	...
	public String getPackageName(String manifestPath) throws Exception{
		DocumentBuilderFactory documentBuilderFactory = DocumentBuilderFactory.newInstance();
		DocumentBuilder documentBuilder = documentBuilderFactory.newDocumentBuilder();
		Document document = documentBuilder.parse(new File(manifestPath));

		Node node = document.getElementsByTagName("manifest").item(0);
		return ((Element)node).getAttribute("package");
	}
